                  ...
                  <div class="header-cart-wrap">
                    ...
                    <ul class="minicart">
                      <li class="d-flex align-items-start">
                        <div class="cart-img">
                          <a href="single-product.blade.php"><img src="img/product/cart_p01.jpg"
                                                                  alt=""></a>
                        </div>
                      ...
                      <li class="d-flex align-items-start">
                        <div class="cart-img">
                          <a href="single-product.blade.php"><img src="img/product/cart_p02.jpg"
                                                                  alt=""></a>
                        </div>
                        <div class="cart-content">
                          <h4><a href="single-product.blade.php">آجیل تازه مزرعه ارگانیک</a></h4>
