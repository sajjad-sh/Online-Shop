...
<head>
	...
	<title>گانیک - فروشگاه اینترنتی خرید و فروش اقلام غذایی</title>
						...
						<div class="header-top-left">
							<ul>
								<li class="header-top-lang">
									<div class="dropdown">
										<button class="dropdown-toggle" type="button" id="dropdownMenuButton2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">پارسی</button>
								...
								<li class="header-top-currency">
									<div class="dropdown">
										<button class="dropdown-toggle" type="button" id="dropdownMenuButton3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">تومان</button>
										...
										<div class="header-cart-wrap">
											...
											<ul class="minicart">
												<li class="d-flex align-items-start">
													<div class="cart-img">
														<a href="single-product.blade.php"><img src="img/product/cart_p01.jpg" alt=""></a>
													</div>
												...
												<li class="d-flex align-items-start">
													<div class="cart-img">
														<a href="single-product.blade.php"><img src="img/product/cart_p02.jpg" alt=""></a>
													</div>
													<div class="cart-content">
														<h4><a href="single-product.blade.php">آجیل تازه مزرعه ارگانیک</a></h4>
														<div class="cart-price">
					...
					<div class="col-12">
						...
						<div class="menu-wrap">
							<nav class="menu-nav">
								...
								<div class="navbar-wrap main-menu d-none d-lg-flex">
									<ul class="navigation">
										<li class="menu-item-has-children"><a href="#">صفحه نخست</a>
											<ul class="submenu">
												<li><a href="home.blade.php">صفحه نخست یک</a></li>
										...
										<li class="active menu-item-has-children"><a href="#">صفحات</a>
											<ul class="submenu">
												<li class="active"><a href="single-product.blade.php">نمونه محصول</a></li>
								...
								<div class="header-super-store d-none d-xl-block d-lg-none d-md-block">
									<div class="dropdown">
										<button class="dropdown-toggle" type="button" id="dropdownMenuButton4" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="flaticon-shop"></i> فروشگاه اینترنتی</button>
						...
						<div class="mobile-menu">
							<nav class="menu-box">
								...
								<div class="nav-logo"><a href="home.blade.php"><img src="img/logo/logo.png" alt="" title=""></a>
								</div>
				...
				<div class="row">
					...
					<div class="col-lg-5">
						<div class="shop-details-content">
							<h4 class="title">بستنی طبیعی ویتامینی گانیک</h4>
							<div class="shop-details-meta">
								<ul>
									<li>برند : <a href="shop.html">گانیک</a></li>
									...
									<li>کد محصول : <span>QZX8VGH</span></li>
								</ul>
							</div>
							<div class="shop-details-price">
								<h2 class="price">20.000 تومان</h2>
								<h5 class="stock-status">- موجود در انبار</h5>
							</div>
							<p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد.</p>
							<div class="shop-details-list">
								<ul>
									<li>نوع : <span>بستنی</span></li>
									<li>تاریخ انقضا : <span>15 خرداد 1500</span></li>
									<li>برند : <span>گانیک</span></li>
								</ul>
							</div>
					...
					<div class="col-12">
						<div class="product-desc-wrap">
							<ul class="nav nav-tabs" id="myTabTwo" role="tablist">
								...
								<li class="nav-item">
									<a class="nav-link" id="val-tab" data-toggle="tab" href="#val" role="tab" aria-controls="val" aria-selected="false">محصولات مشابه</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" id="review-tab" data-toggle="tab" href="#review" role="tab" aria-controls="review" aria-selected="false">دیدگاه کاربران</a>
								</li>
							</ul>
							...
							<div class="footer-contact-list">
								<ul>
									...
									<li>
										...
										<p><a href=""><span class="__cf_email__" data-cfemail="70030500001f020430061517151e5e131f1d">[email&#160;protected]</span></a></p>
									</li>
									<li>
						...
						<div class="footer-widget footer-box-widget mb-50">
							<div class="f-download-wrap">
								...
								<div class="download-btns">
									<a href="home.blade.php"><img src="img/icon/g_play.png" alt=""></a>
									<a href="home.blade.php"><img src="img/icon/app_store.png" alt=""></a>
								</div>
							</div>
