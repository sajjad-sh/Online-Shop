...
{{--                    <label for="m_titles[]">مشخصات چندانتخابی</label>--}}
{{--                    <button type="button" class="btn btn-default" onclick="addSelectField()">+</button>--}}
{{--                    <br>--}}
{{--                    @foreach($product->selective_attributes as $value_id => $value_details)--}}

{{--                      @foreach($value_details as $value)--}}
{{--                        <select class="form-control select2 select2-{{$loop->iteration}}" style="width: 30%; display: inline-block;" name="m_titles[]"--}}
{{--                        id="m_titles[]">--}}
{{--                        <option value="{{$value_id}}" selected="selected">{{$value[2]}}</option>--}}
{{--                        @foreach($all_titles as $title)--}}
{{--                          @if($title == $value[2])--}}
{{--                            @continue--}}
{{--                          @endif--}}
